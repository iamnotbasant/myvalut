...
const svgs = JSON.parse(fs.readFileSync('scripts/extracted_all_svgs.json', 'utf8'));
console.log('Generating exact icons from', svgs.length, 'SVGs');

// Let's create an icon generator that exports exact SVG components matching Stashr
...
export function ViewMosaic({ className = 'size-4', ...props }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
      ...
      <path d="M3.69797 19.7472C2.5 18.3446 2.5 16.2297 2.5 12C2.5 7.77027 2.5 5.6554 3.69797 4.25276C5.6554 2.5 7.77027 2.5 12 2.5C16.2297 2.5 18.3446 2.5 19.7472 3.69797C21.5 5.6554 21.5 7.77027 21.5 12C21.5 16.2297 21.5 18.3446 20.302 19.7472C18.3446 21.5 16.2297 21.5 12 21.5C7.77027 21.5 5.6554 21.5 4.25276 20.302Z" />
    </svg>
  );
}
...
fs.writeFileSync('src/components/icons.tsx', iconsCode, 'utf8');
console.log('Saved src/components/icons.tsx successfully!');
