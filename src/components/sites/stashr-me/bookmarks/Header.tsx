...
export function Header({
  ...
  return (
    <header className="flex h-[54px] shrink-0 items-center justify-between border-b border-white/[0.08] bg-[#1c1c1f] pr-[9px] pl-2">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="group/button inline-flex size-8 shrink-0 select-none items-center justify-center whitespace-nowrap rounded-lg border border-transparent font-medium text-sm outline-none transition-all hover:bg-white/10 text-neutral-400 hover:text-white"
          >
      ...
      {/* Right: Extension Indicator + User Profile Avatar */}
      <div className="flex items-center gap-1.5">
        ...
        <a
          ...
          className="relative inline-flex size-8 shrink-0 items-center justify-center rounded-lg text-neutral-400 hover:text-white hover:bg-white/10 transition-colors"
        >
            ...
            <div className="absolute right-0 top-full z-50 mt-1 w-56 rounded-2xl border border-white/10 bg-[#1c1c1f] p-1.5 text-popover-foreground shadow-2xl backdrop-blur-md animate-in fade-in-50 zoom-in-95">
              ...
              <div className="border-t border-white/10 pt-1">
                <button
                  ...
                  className="flex w-full items-center justify-between rounded-lg px-2.5 py-1.5 text-xs text-neutral-300 hover:bg-white/10 hover:text-white transition-colors"
                >
                  <span>Theme</span>
